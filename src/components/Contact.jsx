        ...
        <div className="border-b border-neutral-900 pb-20">
            ...
            <div className="text-center tracking-tighter">
                <motion.p
                    ...
                    className="my-4 text-center tracking-tight bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text  text-transparent lg:mt-5"
                >
                    {CONTACT?.address}
                </motion.p>
                <motion.p
                ...
                >
                    <a
                        ...
                        className="border-b my-4 text-center tracking-tight bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text  text-transparent lg:mt-10"
                    >
                        {CONTACT?.phoneNo}
                    </a>
                </motion.p>
