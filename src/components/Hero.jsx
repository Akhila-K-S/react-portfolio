...
const Hero = () => {
    return (
        <section className="border-b border-neutral-900 pb-20 pt-4 lg:pb-28 lg:pt-8">
            <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
                ...
                >
                    <motion.div
                        ...
                        className="mb-6 inline-flex items-center gap-2 rounded-full border border-neutral-800 bg-neutral-900/60 px-4 py-1.5 text-sm text-neutral-400"
                    >
                    ...
                    >
                        {TECH_PILLS.map((tech) => (
                            <span
                                key={tech}
                                className="rounded bg-neutral-900 px-2 py-1 text-sm font-light tracking-tighter text-purple-500"
                            >
                                {tech}
                            </span>
                        ))}
                    ...
                    >
                        <a
                            ...
                            target="_blank"
                            className="flex h-10 w-10 items-center justify-center rounded-lg border border-neutral-800 bg-neutral-900/60 transition-colors hover:border-neutral-600"
                            aria-label="LinkedIn"
                        >
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="mt-6 flex items-center gap-1.5 text-sm text-neutral-400"
                    >
                        <HiOutlineMapPin />
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="absolute -bottom-4 -left-4 rounded-xl border border-neutral-800/80 bg-neutral-900/95 px-4 py-3 backdrop-blur-md"
                    >
                    ...
                    <motion.div
                        ...
                        className="absolute -right-3 top-6 rounded-xl border border-neutral-800/80 bg-neutral-900/95 px-3 py-2 backdrop-blur-md"
                    >
                        <p className="text-xs font-medium text-purple-100">React Native</p>
                        <p className="text-[10px] text-neutral-400">& React.js Expert</p>
                    </motion.div>
                </motion.div>
            </div>
        </section>
